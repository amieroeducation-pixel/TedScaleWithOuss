...
The keys live in `.claude/settings.json` (project) or `C:/Users/Ted/Documents/GitHub/TedScaleWithOuss/.claude/settings.json` (global) — **not** in `.planning/config.json`:
