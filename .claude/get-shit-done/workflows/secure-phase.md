...
```
Agent(
  prompt="Read C:/Users/Ted/Documents/GitHub/TedScaleWithOuss/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Users/Ted/Documents/GitHub/TedScaleWithOuss/.claude/get-shit-done/templates/SECURITY.md`
