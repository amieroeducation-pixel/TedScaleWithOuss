...
```bash
INIT=$(node "C:/Users/Ted/Documents/GitHub/TedScaleWithOuss/.claude/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "C:/Users/Ted/Documents/GitHub/TedScaleWithOuss/.claude/get-shit-done/bin/gsd-tools.cjs" commit \
