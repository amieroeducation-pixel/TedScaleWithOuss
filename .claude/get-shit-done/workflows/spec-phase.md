...
```bash
INIT=$(node "C:/Users/Ted/Documents/GitHub/TedScaleWithOuss/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @C:/Users/Ted/Documents/GitHub/TedScaleWithOuss/.claude/get-shit-done/templates/spec.md.
