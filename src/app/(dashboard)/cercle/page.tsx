...
interface Partner {
  ...
  city: string
  fonction: string
  // orbital position (absolute, within the 520px circle container)
  top?: string
  bottom?: string
  left?: string
  right?: string
...
export default function CerclePage() {
  ...
  const [settingsForms, setSettingsForms] = useState<Record<string, {
    fullName: string; fonction: string; cabinet: string; city: string;
    photoUrl: string; linkedin: string; mobile: string; email: string;
    status: string;
  }>>(
    Object.fromEntries(PARTNERS.map(p => [p.id, {
    ...
    <>
      ...
      <div style={{ marginBottom: 20 }}>
        ...
        <div style={{ fontFamily: 'JetBrains Mono,monospace', fontSize: 10, color: C.textLo, paddingLeft: 13 }}>
          6 partenaires clés · Vision d'ensemble · Relances & actions
        </div>
      </div>
      ...
      {tab === 'visual' && (
        <>
          <div style={{ textAlign: 'center', marginBottom: 20 }}>
            ...
            <div style={{ fontSize: 11, color: C.textLo }}>6 partenaires clés · Vision d'ensemble</div>
          </div>
          ...
          <Panel style={{ marginBottom: 20 }}>
            <div style={{ position: 'relative', width: '100%', height: 520, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              ...
              <div style={{
                ...
                <div style={{ fontFamily: 'Oswald,sans-serif', fontSize: 36, color: C.gold, fontWeight: 700, marginTop: 4 }}>6</div>
      ...
      {tab === 'settings' && (
        <>
          <div style={{ marginBottom: 20 }}>
            ...
            <div style={{ fontSize: 10, color: C.textLo }}>Personnalisez vos contacts : photos, LinkedIn, coordonnées...</div>
          </div>
                  ...
                  <div style={{ display: 'flex', gap: 16 }}>
                    ...
                    <div style={{ flex: 1 }}>
                        ...
                        <div>
                          ...
                          <input
                            ...
                            style={{
                              width: '100%', padding: '6px 8px',
                              background: C.surface1, border: `0.5px solid ${C.line}`,
                              borderRadius: 5, color: C.gold, fontSize: 10,
                              boxSizing: 'border-box',
                            }}
                          />
                        </div>
                        <div>
                          ...
                          <input
                            ...
                            style={{
                              width: '100%', padding: '6px 8px',
                              background: C.surface1, border: `0.5px solid ${C.line}`,
                              borderRadius: 5, color: '#0a66c2', fontSize: 10,
                              boxSizing: 'border-box',
                            }}
                          />
                        </div>
                        ...
                        <div>
                          ...
                          <select
                            ...
                            style={{
                              width: '100%', padding: '6px 8px',
                              background: C.surface1, border: `0.5px solid ${C.line}`,
                              borderRadius: 5, color: PRESSURE[form.status as keyof typeof PRESSURE]?.border || C.textHi,
                      ...
                      <div style={{ marginTop: 12, display: 'flex', gap: 8, justifyContent: 'flex-end' }}>
                        ...
                        <button style={{
                          padding: '6px 12px',
                          background: `${C.green}15`, border: `0.5px solid ${C.green}`,
                          color: C.green, borderRadius: 5, fontSize: 10,
