...
const VALID_SECTIONS = ['/today', '/dashboard', '/crm', '/global', '/revenue', '/clients', '/pipeline', '/analytics', '/achievements', '/automatisations', '/sequences', '/settings', '/prospection/tns', '/prospection/chefs-entreprise', '/prospection/particuliers', '/assistant', '/simulator', '/scoring', '/commerce', '/map', '/tasks', '/cercle', '/playbooks', '/donnees', '/nurturing']
